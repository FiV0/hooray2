...
(deftype PersistentSortedMap [^PersistentSortedSet set ^IPersistentMap _meta]
  ...
  ;; TODO understand why java.util.Map adds the requirement for types hints
  ;; (forEach [this ^Consumer action] (throw-unsupported))
  (spliterator [this] (throw-unsupported))
