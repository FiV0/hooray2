    ...
    companion object {
        ...
        fun createSingleLevel(deltas: ZSet<Extension, IntegerWeight>, participatesInLevel: Int): IncrementalPrefixExtender {
            return object : IncrementalPrefixExtender {
                ...
                override fun propose(prefix: Prefix): ZSet<Extension, IntegerWeight> = deltas

                override fun extend(prefix: Prefix, extensions: ZSet<Extension, IntegerWeight>): ZSet<Extension, IntegerWeight>
                        = extensions.filterKeys { ext -> deltas.containsKey(ext) }
...
class IncrementalGenericJoin(val extenders: List<IncrementalPrefixExtender>, levels: Int): IncrementalJoin<Any> {
    override fun join(): ZSet<Any, IntegerWeight> {
